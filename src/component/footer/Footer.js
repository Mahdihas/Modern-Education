...
const Footer = () => {
  return (
      <div>
          ...
          <footer className="footer p-10 bg-slate-300 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 ">
  <div>
  ...
  <div>
    <span className="footer-title text-[#302e2c]">Company</span> 
  ...
  <div>
    <span className="footer-title text-[#302e2c]">Legal</span> 
    <a className="link link-hover">Terms of use</a> 
    <a className="link link-hover">Privacy policy</a> 
    <a className="link link-hover">Cookie policy</a>
  </div>
</footer> 
<footer className="footer px-10 py-4 border-t bg-[#0e0d0c]  text-white border-base-300">
